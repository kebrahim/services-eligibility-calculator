...
# Custom services_rw user
mysql -uroot -e "CREATE USER 'services_rw'@'localhost' IDENTIFIED BY 'services_dev_pw'"
mysql -uroot -e "GRANT ALL PRIVILEGES ON *.* TO 'services_rw'@'localhost';"

# Create Boulder database & schema
